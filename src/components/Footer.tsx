...
export default function Footer() {
  ...
  const isInAbout = pathname === '/about';
  const isInFAQ = pathname === '/faq';

  return (
    <footer className="py-4 px-8">
      <div className="max-w-4xl mx-auto flex flex-col items-center gap-1">
        <div className="flex items-center gap-4">
          {(isInSpace || isInPrivacyPolicy || isInSettings || isExample || isInAbout || isInFAQ) && (
            <Link
              href="/"
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="https://github.com/digidubae/sharpr.me"
            target="_blank"
