    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center">
      <div className="w-full max-w-md mx-auto p-4">
        <div className="bg-white shadow-lg rounded-xl p-8 transition-all duration-200 hover:shadow-xl">
          <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">Create New Space</h1>
          ...
          <div className="space-y-6">
              ...
              <div className="text-sm text-red-600 bg-red-50 p-3 rounded-lg">
                ...
                {existingSpaceId && (
                  <button
                    ...
                    className="text-blue-600 hover:text-blue-700 underline mt-2 font-medium"
                  >
                    Open existing space
                  </button>
                )}
            ...
            <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4 pt-4">
              ...
              <button
                onClick={() => router.push('/')}
                className="flex-1 px-6 py-3 border-2 border-gray-200 text-sm font-medium rounded-lg
