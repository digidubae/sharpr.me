        ...
        <div className="space-y-8">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <section className="mb-8">
              ...
              <p>
                Sharpr.me is a knowledge management tool without the hassle of all the other tools.  Focusing on simplicity, <a href="/privacy-policy">data privacy</a>, and ease of use, Sharpr.me may be the right tool for you too 🙂
              </p>
            </section>
